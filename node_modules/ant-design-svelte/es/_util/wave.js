var attributeName = 'ant-click-animating-without-extra-node';
var styleForPesudo;
...
function getWaveColor(node) {
    return (getComputedStyle(node).getPropertyValue('border-top-color') || // Firefox Compatible
...
export default function (node, isEnable) {
    ...
    var onClick = function () {
        resetEffect(node);
        var waveColor = getWaveColor(node);
